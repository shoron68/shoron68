...
const MakeProjects = () => {
  return (
   ...
   <Container className="lg:py-[124px] py-[60px]">
    <div className="">
  <h2  data-aos="fade-up" data-aos-delay="0" className="lg:text-[80px] text-[50px] lg:text-start text-center font-Poppins font-semibold bg-gradient-to-br from-[#ade6e7] to-[#80ed99] bg-clip-text text-transparent">
    HOW I MAKE PROJECTS?
  </h2>
</div>
...
<div className="grid lg:grid-cols-3 grid-rows-1 gap-12 items-center lg:mt-[150px] mt-[80px] lg:mx-0 mx-[30px]">
          <div >
            <div data-aos="zoom-in" data-aos-delay="0"  className="p-[20px] border-[1px] border-[#ffffff70] bg-[#212121] rounded-xl hover:scale-103 duration-300">
    ...
    <div >
      <div  data-aos="zoom-in" className="p-[20px] border-[1px] border-[#ffffff70] bg-[#212121] rounded-xl  hover:scale-103 duration-300">
              <h4 className='text-[20px] text-[#fff] font-Poppins font-medium'>Brainstorming & UI Design</h4>
              <p className='text-[16px] text-[#ffffffb6] font-Poppins font-normal py-[13px]'>Every project starts with brainstorming and planning. I create a visually appealing and user-friendly UI design to enhance effectiveness.</p>
              <img src={img2} alt="" />
            </div>
    ...
    <div >
      <div  data-aos="zoom-in" className="p-[20px] border-[1px] border-[#ffffff70] bg-[#212121] rounded-xl hover:scale-103 duration-300">
        ...
        <div  data-aos="fade-up" data-aos-delay="0" className="bg-gradient-to-br from-[#80ed99] to-[#38a3a5] py-[30px] px-[20px]  rounded-md mt-[150px] lg:mx-0 mx-[30px]">
