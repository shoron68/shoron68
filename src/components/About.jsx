        ...
        <Container>
            <div data-aos="fade-up" data-aos-delay="0" className="border-[1px] border-[#ffffff70] lg:py-[80px] py-[40px] rounded-2xl bg-[#ffffff11] lg:mx-0 mx-[30px]">
                    ...
                    <div className="lg:flex  lg:mx-[100px] mx-[10px] items-center mt-[50px]">
                        <div data-aos="fade-up" data-aos-delay="600" className="h-[400px] w-[350px] bg-[#80ed99] rounded-2xl lg:block hidden"></div>
                        <div className="lg:w-[700px] lg:ml-[200px]">
                            <h3 data-aos="fade-up" data-aos-delay="600" className='lg:text-[38px] text-[30px] font-Audiowide font-medium text-[#fff] lg:text-start text-center'>Musfiqur Rahman</h3>
                            <p data-aos="fade-up" data-aos-delay="800" className='lg:text-[16px] text-[14px] font-Poppins font-normal text-[#ffffffb4] py-[20px] lg:text-start text-center '>I’m a passionate front-end development graduate specializing in React and JavaScript, focused on building user-friendly, responsive interfaces. I aim to contribute to dynamic teams by applying my skills in React components, HTML5, CSS3, and modern JavaScript libraries. As a lifelong learner, I continuously seek opportunities to grow through collaboration and hands-on experience.</p>
                            <div data-aos="fade-up" data-aos-delay="800" className="flex justify-center lg:justify-normal">
                            ...
                            <div data-aos="fade-up" data-aos-delay="1000" className="flex lg:justify-normal justify-center gap-x-4 mt-[30px]">
