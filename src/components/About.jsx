...
const About = () => {
  return (
    <div id='about' className='lg:py-[124px] lg:pt-0 pt-[120px]'>
        ...
        <Container>
            <div data-aos="fade-up" data-aos-duration="100" className="border-[1px] border-[#ffffff70] lg:py-[80px] py-[40px] rounded-2xl bg-[#ffffff11] lg:mx-0 mx-[30px]">
                    <div className="">
                        <h2 data-aos="fade-up" data-aos-duration="300" className=' text-[#fff] font-Poppins text-[26px] text-center'>About me</h2>
                    </div>
                    <div className="lg:flex  lg:mx-[100px] mx-[10px] items-center mt-[50px]">
                        <div data-aos="zoom-in" data-aos-duration="300" className="h-[350px] w-[350px] lg:block hidden">
                            <img src={profile2} className='rounded-xl' alt="" />
                        </div>
                        <div className="lg:w-[700px] lg:ml-[200px]">
                            <h3 data-aos="fade-up" data-aos-duration="300" className='lg:text-[38px] text-[30px] font-Audiowide font-medium text-[#fff] lg:text-start text-center'>Musfiqur Rahman</h3>
                            ...
                            <div data-aos="fade-up" data-aos-duration="300" className="flex justify-center lg:justify-normal">
                            ...
                            <div data-aos="fade-up" data-aos-duration="300" className="flex lg:justify-normal justify-center gap-x-4 mt-[30px]">
