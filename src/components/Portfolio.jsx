...
import image2 from "../assets/coffe.png"
...
const Portfolio = () => {
  return (
    <div id='portfolio' className=' lg:py-[124px] py-[60px] lg:pt-0 pt-[120px]'>
      <Container>
        <div className="">
          <h4 data-aos="fade-up" data-aos-duration="200" className='text-[28px] font-Poppins font-normal text-[#fff] text-center'>My Portfolio</h4>
          <p data-aos="fade-up" data-aos-duration="300" className='text-[16px] font-Poppins font-normal text-[#ffffffaf] text-center mt-[5px]'>Watch my featured projects</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 grid-rows-1 gap-12 mt-[100px] items-center lg:mx-0 mx-[30px]">
          ...
          <div data-aos="fade-right" data-aos-duration="200" className="lg:col-start-3">
            <div className="">
            ...
            <div data-aos="fade-right" data-aos-delay="200" className="">
              ...
              <div className="mt-[30px] lg:justify-normal flex justify-center ">
                <div className="flex gap-x-[20px] lg:order-0 order-1">
                  ...
                  <a href="https://github.com/shoron68/coffe-shop" target='blank' className=' font-Poppins font-normal text-[#fff] py-[10px] px-[15px]  bg-[#212121] hover:text-[#80ed99] duration-300 rounded-[5px] text-[20px]'><FaGithub /></a>
                </div>
              </div>
            </div>
          </div>
